                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => InsecticideDetailScreen(data: item),
                      ),
                    );
                  },
                  child: Container(
                    margin: const EdgeInsets.only(bottom: 16),
                    clipBehavior: Clip.antiAlias, // Border radius နဲ့ background ညီညွတ်စေရန်
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Icon(Icons.gavel_rounded, size: 14, color: Colors.red.shade700),
                                  const SizedBox(width: 6),
                                  Expanded(
                                    child: Text(
                                      "နှိမ်နင်းနိုင်မှု - ${item.targetPest}",
                                      style: TextStyle(
